...
class TBL_CAF_Solicitud(Base):
    ...
    Presupuesto_existente = Column(String(500), nullable=True)
    Tipo_trabajo = Column(String(100), nullable=True)
    Recuperable = Column(String(100), nullable=True)
    Justificacion_trabajo = Column(String(1000), nullable=True)
    ...
    # Bitácora de reasignaciones del Responsable: una línea por cambio, con
    # formato "YYYY-MM-DD HH:MM | quien | anterior -> nuevo | motivo".
